...
export class ClientesController extends ControllerBase implements IClientesController {

    constructor(data?: IClientesController) {
        super(data);
    }
    ...
    static fromJS(data: any): ClientesController {
        data = typeof data === 'object' ? data : {};
        let result = new ClientesController();
        result.init(data);
        return result;
    }
...
export interface IClientesController extends IControllerBase {
}
...
export class ControllerContext extends ActionContext implements IControllerContext {
    ...
    constructor(data: ControllerContext) {
        super(data);
    }
    ...
    static fromJS(data: any): ControllerContext {
        data = typeof data === 'object' ? data : {};
        let result = new ControllerContext(data);
        result.init(data);
        return result;
    }
